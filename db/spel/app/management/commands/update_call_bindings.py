        ...
        with open(csv_file, newline="") as f:
            ...
            for row in reader:
                ...
                if scope == "ELMTYPE":
                    ...
                    inst_mod_obj = Modules.objects.get(module_name=var_mod)
                    ...
                    local_obj = None
                    member_obj = None
                    arg_obj = SubroutineArgs.objects.get(
                        subroutine=p_sub_obj, arg_name=var_name
                    )
                elif scope == "LOCAL":
                    instance_obj = None
                    member_obj = None
                ...
                call_binding_obj = CallsiteBinding.objects.update_or_create(
                    parent_subroutine=p_sub_obj,
                    call=calltree_obj,
                    dummy_arg=dummy_arg_obj,
                    nested_level=nested_level,
                    var_name=var_name,
                    member_path_str=member_path,
